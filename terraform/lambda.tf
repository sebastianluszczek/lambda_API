...
data "archive_file" "local_zip_getUsers" {
  source_file = "../dist/getUsers.js"
  type = "zip"
  output_path = "../dist/getUsers.zip"
}

data "archive_file" "local_zip_getUser" {
  source_file = "../dist/getUser.js"
  type = "zip"  
  output_path = "../dist/getUser.zip"
}

data "archive_file" "local_zip_createUser" {
  source_file = "../dist/createUser.js"
  type = "zip"
  output_path = "../dist/createUser.zip"
}

data "archive_file" "local_zip_deleteUser" {
  source_file = "../dist/deleteUser.js"
  type = "zip"
  output_path = "../dist/deleteUser.zip"
}
